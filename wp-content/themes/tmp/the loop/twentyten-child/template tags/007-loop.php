...
while ( have_posts() ) :
	...
	<ul>
		...
		<li>permalink_anchor()		: <?php permalink_anchor();?> </li>
		<li>get_permalink()			: <?php echo get_permalink();?> </li>
		<li>get_post_permalink()	: <?php echo get_post_permalink();?> </li>
		<li>get_page_link()			: <?php echo get_page_link();?> </li>
		<li>get_attachment_link()	: <?php echo get_attachment_link();?> </li>
		
		<li>wp_shortlink_header()	: <?php echo wp_shortlink_header();?> </li>
		<li>wp_shortlink_wp_head()	: <?php echo wp_shortlink_wp_head();?> </li>
		
		<li>edit_bookmark_link()	: <?php echo edit_bookmark_link();?> </li>
		<li>edit_comment_link()		: <?php echo edit_comment_link();?> </li>
		<li>edit_post_link()		: <?php echo edit_post_link();?> </li>
		<li>get_edit_post_link()	: <?php echo get_edit_post_link();?> </li>
		<li>get_delete_post_link()	: <?php echo get_delete_post_link();?> </li>
		<li>edit_tag_link()			: <?php echo edit_tag_link();?> </li>
		<li>get_admin_url()			: <?php echo get_admin_url();?> </li>
		<li>get_home_url()			: <?php echo get_home_url();?> </li>
		
		<li>get_site_url()			: <?php echo get_site_url();?> </li>
		<li>home_url()				: <?php echo home_url();?> </li>
		<li>site_url()				: <?php echo site_url();?> </li>
		<li>get_search_link()		: <?php echo get_search_link('happy');?> </li>
		<li>get_search_query()		: <?php echo get_search_query();?> </li>
	</ul>
</div>
