<?php
class Zendvn_Theme_Widget_LastPost extends WP_Widget {

	//private $_cache_name = 'zendvn_mp_wg_last_post_caching';
	public function __construct() {
		//echo '<br/>' . __METHOD__;
		$id_base = 'zendvn-theme-widget-last-post';
		$name	= 'Zendvn Last Post';
	...
	public function widget( $args, $instance ) {
		...
		if($show_type == 'sidebar' ){
			require ZENDVN_THEME_WIDGET_DIR . '/html/last_post_sidebar.php';
		}else if($show_type == 'last_news'){
			require ZENDVN_THEME_WIDGET_DIR . '/html/last_post_news.php';
		}else if($show_type == 'last_gallery'){
			require ZENDVN_THEME_WIDGET_DIR . '/html/last_post_gallery.php';
		}
